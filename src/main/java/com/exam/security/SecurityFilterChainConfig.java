...
<<<<<<< HEAD
		    .antMatchers("/login","/home","/signup","/webjars/**","/images/**","/books","/css/**","/js/**","/idCheck").permitAll()
=======
		    .antMatchers("/login","/home","/signup","/webjars/**","/images/**","/books","/css/**","/js/**","/editMember","/memberList").permitAll()
>>>>>>> HJG
		    .anyRequest()
		    .authenticated();
